  ...
  methods: {
    ...
    handleCategoryTap(index) {
      ...
      switch(category.type) {
        case 'guided':
          targetPage = '/pages/music/index?type=guided';
          break;
        case 'nature':
          targetPage = '/pages/intervene/nature';
          break;
        case 'music':
          targetPage = '/pages/music/index?type=music';
          break;
        default:
          uni.showToast({
            title: '功能开发中',
    ...
    playAudio(index) {
      ...
      // 跳转到音乐播放器页面
      uni.navigateTo({
        url: '/pages/music/player?title=' + encodeURIComponent(audio.title) + '&duration=' + audio.duration,
        fail: () => {
          uni.showToast({
            title: '播放器加载失败',
            icon: 'none'
